...
module.exports = {
    ...
    execute: function (command, args) {
        ...
        return create_jsx_script(command)
            ...
            .then(jsx => new Promise(resolve => {
                exec(`afterfx.exe -r ${jsx.script} ${args}`, {cwd: jsx.program_path}, (/*err, stdout, stderr*/) => {
                    // see * below
    ...
    executeSync: function (command, args) {

        const jsx = create_jsx_script(command, true);
        //Execute JSX
        try {
            execSync(`afterfx.exe -r ${jsx.script} ${args}`, {cwd: jsx.program_path});
        } catch (err) {
            //TODO *
